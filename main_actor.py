...
def main():
    ...
    env = BattlesnakeEnvironment(config, enemy_agents=enemy_agents,
                                 output_directory=f'{config.output_directory}/actor-{args.actor_index}', actor_idx=args.actor_index,
