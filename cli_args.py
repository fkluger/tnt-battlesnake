...
def get_args():
    ...
    parser.add_argument('--width', type=int, default=11, help='Width of the board.')
    parser.add_argument('--height', type=int, default=11, help='Height of the board.')
    ...
    parser.add_argument('--frames', type=int, default=3, help='Frames of the game to concatenate.')
    ...
    parser.add_argument('--learning_rate', type=float, default=0.00005, help='Learning rate of the optimizer.')
    parser.add_argument('--training_interval', type=int, default=4, help='Run a training epoch every n observations.')

    parser.add_argument('--target_update_freq', type=int, default=32000,
    ...
    parser.add_argument('--replay_alpha_prio', type=float, default=0.5,
