...
class DistributionalDuelingDoubleDQNBrain(DuelingDoubleDQNBrain):
    ...
    def create_model(self):
        ...
        output_distributions = Dense(self.num_quantiles * self.num_actions)(hidden)
        output_distributions = Reshape((self.num_actions, self.num_quantiles))(output_distributions)
